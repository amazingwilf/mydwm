...
enum { SchemeNorm, SchemeSel, SchemeLtSym, SchemeEmptyTag }; /* color schemes */
  ...
  if (display != NULL) {
    ...
    if (resm != NULL) {
      ...
      if (xrdb != NULL) {
        ...
        XRDB_LOAD_COLOR("dwm.ltsymbordercolor", ltsymbordercolor);

        XRDB_LOAD_COLOR("dwm.emptytagfgcolor", emptytagfgcolor);
        XRDB_LOAD_COLOR("dwm.emptytagbgcolor", emptytagbgcolor);
        XRDB_LOAD_COLOR("dwm.emptytagbordercolor", emptytagbordercolor);
